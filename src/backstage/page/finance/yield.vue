    ...
    <div class="containers">
        ...
        <el-row class="mt-4 d-flex flex-row flex-nowrap justify-content-end">
            <div style="flex-grow:1" >
                <el-button  icon="el-icon-plus" @click="handleAdd" type="primary">编辑</el-button>
            </div>             
            <el-button-group>
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="PROFITUID" label="序号" align="center"></el-table-column>
            <el-table-column prop="MACHINEUID" label="时间" align="center"></el-table-column>
            <el-table-column prop="PROFIT" label="日志" align="center"></el-table-column>
            <el-table-column prop="PROFITTIME" label="备注" align="center"></el-table-column>
