<template>
    <div class="containers">
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="RULEUID" label="ID" align="center"></el-table-column>
            ...
            <el-table-column prop="PARENTUID" label="父级" align="center"></el-table-column>
            <el-table-column prop="LEVEL" label="等级" align="center"></el-table-column>
            <el-table-column prop="ISNAV" label="导航栏" align="center"></el-table-column>
