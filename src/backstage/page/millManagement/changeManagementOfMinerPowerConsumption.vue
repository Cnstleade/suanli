...
<template>
    <div class="containers">
        ...
        <el-table
            ...
            <el-table-column prop="MACHINENAME" label="矿机ID" align="center"></el-table-column>
            <el-table-column prop="CODE" label="当前功耗" align="center"></el-table-column>
            <el-table-column prop="MINERUID" label="变化时间" align="center"></el-table-column>
            <el-table-column prop="ROW" label="添加者" align="center"></el-table-column>
