...
<template>
    <div class="containers">
        ...
        <el-table
            ...
            <el-table-column prop="MACHINEGOODSNAME" label="秘钥" align="center"></el-table-column>
            <el-table-column prop="MACHINEGOODSMODEL" label="回调地址" align="center"></el-table-column>
            <el-table-column prop="SALETIME" label="添加时间" align="center"></el-table-column>
