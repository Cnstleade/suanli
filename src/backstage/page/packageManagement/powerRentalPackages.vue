...
<template>
    <div class="containers">
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="POWERGOODSUID" label="ID" align="center"></el-table-column>
            <el-table-column prop="POWERGOODSNAME" label="套餐名称" align="center"></el-table-column>
            <el-table-column prop="POWERGOODSPRICE" label="算力价格" align="center"></el-table-column>
            <el-table-column prop="POWERGOODSSIZE" label="算力大小" align="center"></el-table-column>
            <el-table-column prop="POWERGOODSTYPE" label="算理类型" align="center"></el-table-column>
            <el-table-column prop="POWERGOODSTIME" label="使用期限" align="center"></el-table-column>
            ...
            <el-table-column prop="ISSALE" label="是否上架" align="center"></el-table-column>
            <el-table-column prop="SALETIME" label="上架时间" align="center"></el-table-column>
            <el-table-column prop="WORKDAY" label="开始工作时间" align="center"></el-table-column>
            <el-table-column prop="CONTENT" label="详细介绍" align="center"></el-table-column>
