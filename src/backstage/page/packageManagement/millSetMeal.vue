...
<template>
    <div class="containers">
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="MACHINEGOODSUID" label="ID" align="center"></el-table-column>
            <el-table-column prop="MACHINEGOODSNAME" label="套餐名称" align="center"></el-table-column>
            <el-table-column prop="MACHINEGOODSMODEL" label="矿机型号" align="center"></el-table-column>
            <el-table-column prop="MACHINEGOODSNUMBER" label="矿机数量" align="center"></el-table-column>
            <el-table-column prop="MACHINEGOODSPRICE" label="套餐价格" align="center"></el-table-column>
