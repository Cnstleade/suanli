    ...
    <div class="containers">
        ...
        <el-row class="mt-4 d-flex flex-row flex-nowrap justify-content-end">
            ...
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
              ...
              <el-form-item >
                <el-select v-model="formInline.region" placeholder="品牌">
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="MODELUID" label="ID" align="center"></el-table-column>
            <el-table-column prop="	MODELNAME" label="型号名称" align="center"></el-table-column>
            <el-table-column prop="BRANDUID" label="品牌" align="center"></el-table-column>
            <el-table-column prop="MODELPOWER" label="额定算力" align="center"></el-table-column>
            <el-table-column prop="PRICE" label="矿机价格" align="center"></el-table-column>
            <el-table-column prop="	THUMB" label="商品图片" align="center"></el-table-column>
            <el-table-column prop="QA" label="矿机质保(年)" align="center"></el-table-column>
            <el-table-column prop="POWERWASTE" label="功耗kw/h" align="center"></el-table-column>
            <el-table-column prop="ATTENTION" label="注意事项" align="center"></el-table-column>
            <el-table-column prop="CHIP" label="芯片" align="center"></el-table-column>
            <el-table-column prop="TEMPERATURE" label="工作温度" align="center"></el-table-column>
            <el-table-column prop="HUMIDITY" label="工作湿度" align="center"></el-table-column>
            <el-table-column prop="NETWORK" label="网络连接(以太网)" align="center"></el-table-column>
            <el-table-column prop="SIZE" label="机身尺寸" align="center"></el-table-column>
