<template>
    <div class="containers">
        ...
        <el-table
            ...
            class="mt-3"
            v-loading="loading">
            <el-table-column prop="WITHDRAWUID" label="ID" align="center"></el-table-column>
            <el-table-column prop="ADDRESSUID" label="提现地址" align="center"></el-table-column>
            <el-table-column prop="WITHDRAWNUMBER" label="提现数量" align="center"></el-table-column>
            <el-table-column prop="STATUS" label="手机号" align="center"></el-table-column>
            <el-table-column prop="EMAIL" label="提现状态" align="center"></el-table-column>
            <el-table-column prop="ADMINUID" label="财物员ID" align="center"></el-table-column>
            <el-table-column prop="ADMINTIME" label="操作时间" align="center"></el-table-column>
            <el-table-column prop="ADDTIME" label="添加时间" align="center"></el-table-column>
            <el-table-column prop="SERVICEFEE" label="手续费" align="center"></el-table-column>
